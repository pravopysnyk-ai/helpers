...
class SymSpellUkr:
    def __init__(self, sym_spell, bigrams_folder_path, new_freq_path, dict_path, space_handler, SPACY_UDPIPE_MODEL):
    ...
    def spellify(self, sent):
      ...
      try:
        ...
        return self.space_handler.fried_nails(" ".join(res))
